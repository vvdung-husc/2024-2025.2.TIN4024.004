...
#define BOTtoken "7759363143:AAHneTbnA_mxC2JKmoWpcKsVN2OLKopHqfQ" // your Bot Token (Get from Botfather)
#define CHAT_ID "7734983537"
// Dùng ChatGPT để nhờ hướng dẫn tìm giá trị GROUP_ID này
#define GROUP_ID "-4636480671" // thường là một số âm
