...
#define BLYNK_TEMPLATE_ID "TMPL60jqqyx6H"
#define BLYNK_TEMPLATE_NAME "ESP32 NDDA"
#define BLYNK_AUTH_TOKEN "f9PfsNz3IUvfhL49d_GrLIjDRTIwEcir"
...
void updateBlueButton()
{
  ...
  if (!IsReady(lastTime, 50))
    return; // Kiểm tra debounce mỗi 50ms
