...
#define BOTtoken "8194445899:AAGNiSTC4JtfJzlJDMwLXPdxxLO_4YQ80a4"  // your Bot Token (Get from Botfather)
#define CHAT_ID "6820377651"
// Dùng ChatGPT để nhờ hướng dẫn tìm giá trị GROUP_ID này
#define GROUP_ID "-4649779262" //thường là một số âm
