...
#define BLYNK_TEMPLATE_ID "TMPL6vw-XETzQ"
#define BLYNK_TEMPLATE_NAME "ESP32 API"
#define BLYNK_AUTH_TOKEN "DGWJIhmjklGsc65xLCjoztB41Lz8cTsK"
...
#define OPENWEATHERMAP_KEY "bcf356254cf14f22c48b48d504d500f5"
...
void updateHumi() {
  ...
  if (httpResponseCode > 0) {
    ...
    if (error) {
      ...
      if (humi_ != humidity) { // có thay đổi mới cập nhật lên Blynk
        humi_ = humidity;
        Serial.print("Nhiệt độ: ");
