...
// BLYNK CREDENTIALS
#define BLYNK_TEMPLATE_ID "TMPL6Q24mOvpv"
#define BLYNK_TEMPLATE_NAME "API"
#define BLYNK_AUTH_TOKEN "01-DDerPFHxiff5hIV5wjUUjJ1UDUv7S"
...
#define OPENWEATHERMAP_KEY "caf8911642ee01fd32784c242a5fd9e1"
...
bool IsReady(ulong &ulTimer, uint32_t ms) {
  if (currentMillis - ulTimer < ms) return false;
