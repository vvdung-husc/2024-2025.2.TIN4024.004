...
#define BOTtoken "7657792951:AAE-41Yg22jZPlD8QDLl12MBaOvaN9Nhi1Q"  // your Bot Token (Get from Botfather)

// Dùng ChatGPT để nhờ hướng dẫn tìm giá trị GROUP_ID này
#define GROUP_ID "-4605938355" //thường là một số âm
...
void setup() {
  ...
  bot.sendMessage(GROUP_ID, "Tom dep trai");
}
