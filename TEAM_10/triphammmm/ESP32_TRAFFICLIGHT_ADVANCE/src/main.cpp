...
//1000 ms = 1 seconds
unsigned int rTIME = 5000;  //thời gian chờ đèn đỏ    5 giây
unsigned int yTIME = 3000;  //thời gian chờ đèn vàng  3 giây
unsigned int gTIME = 10000; //thời gian chờ đèn xanh 10 giây

unsigned long currentMiliseconds = 0; // miliseconds hiện tại
unsigned long ledTimeStart = 0;       // thời gian bắt đầu chạy LED
unsigned long nextTimeTotal = 0;      // biến tổng - chỉ để hiển thị
...
bool isDark()
{
  static unsigned long darkTimeStart = 0; // lưu thời gian của việc đọc cảm biến
