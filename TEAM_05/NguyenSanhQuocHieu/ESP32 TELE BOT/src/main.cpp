...
#define BOTtoken "8142926194:AAFqbA24kGX6C9I9DG2RmMHFz0XkQeZyz3o"  // your Bot Token (Get from Botfather)

// Dùng ChatGPT để nhờ hướng dẫn tìm giá trị GROUP_ID này
#define GROUP_ID "-4658746675" //thường là một số âm
...
void setup() {
  ...
  bot.sendMessage(GROUP_ID, "Hieu dep trai");
}
