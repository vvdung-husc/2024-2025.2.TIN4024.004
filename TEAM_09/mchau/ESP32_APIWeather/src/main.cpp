...
#define BLYNK_TEMPLATE_ID "TMPL6vqKDIwBP"
#define BLYNK_TEMPLATE_NAME "ESP32Weather"
#define BLYNK_AUTH_TOKEN "ofEgUrhRy8PCMHo3bE5tXIZ_btWuy1Co"
...
#define OPENWEATHERMAP_KEY "0799d17a3052a5af4e43bcb9d89c1030" // Thay KEY của bạn vào đây
...
void updateTemp()
{
  ...
  if (httpResponseCode > 0)
  {
    ...
    if (temp_ != temp)
    {
      ...
      Blynk.virtualWrite(V5, temp_); // Gửi lên Blynk
    }
  }
  else
  {
...
void onceCalled()
{
  ...
  Blynk.virtualWrite(V4, ip4Info.ip4.c_str()); // Gửi giá trị lên chân ảo V1 trên ứng dụng Blynk.
  Blynk.virtualWrite(V3, link.c_str());        // Gửi giá trị lên chân ảo V2 trên ứng dụng Blynk.
}
...
void uptimeBlynk()
{
  ...
  Blynk.virtualWrite(V2, value); // Gửi giá trị lên chân ảo V0 trên ứng dụng Blynk.
}
