...
//Nguyễn Khuyến
#define BLYNK_TEMPLATE_ID "TMPL6DJZxhwpL"
#define BLYNK_TEMPLATE_NAME "BlynkLED"
#define BLYNK_AUTH_TOKEN "NaAqkLufrue5cUCUCHSO7FbZJapF_Anl"
...
void handleDarkState()
{
  ...
  if (!blueButtonON)
    return; // Không nhấp nháy nếu đèn xanh tắt

  if (IsReady(blinkTime, 500))
  { // Nhấp nháy mỗi 500ms
